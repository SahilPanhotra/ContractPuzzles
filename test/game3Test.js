...
describe('Game3', function () {
  async function deployContractAndSetVariables() {
    ...
    return { game, signer,signer1,signer2,address1,address2,address3 };
  }

  it('should be a winner', async function () {
    const { game, signer,signer1,signer2,address1,address2,address3 } = await loadFixture(deployContractAndSetVariables);
